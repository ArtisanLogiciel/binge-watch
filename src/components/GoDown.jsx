...
export default function GoDown({offset}) {
    ...
    return (
        <div className={`animate-bounce h-8 w-8 text-silver cursor-pointer flex justify-center items-center`} onClick={(e)=> { godown(e) }}>
            <svg className="h-8 w-8 fill-silver/80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
